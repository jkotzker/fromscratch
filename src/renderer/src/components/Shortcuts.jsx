const shortcutList = mod => [
  ...
  [[`${mod} +/=`], 'increase font size by 1px'],
  [[`${mod} -`], 'decrease font size by 1px'],
  [[`${mod}+0`], 'reset font size to 16px'],
  [[`${mod}+t`], 'choose font and size'],
  ...
  [[`${mod}+i`], 'switch between light and dark colour scheme'],
